...
class LegislationUpdateService
{
    ...
    public function update(array $request)
    {
        try {
            ...
            $legislation = $this->legislationService->update($legislationData, $request['legislation_id']);
            
            $old_authors = LegislationLegislationAuthor::where('legislation_id', $request['legislation_id'])->get();
            $old_subjects = LegislationLegislationSubjects::where('legislation_id', $request['legislation_id'])->get();
            $old_sections = LegislationSection::where('legislation_id', $request['legislation_id'])->get();
