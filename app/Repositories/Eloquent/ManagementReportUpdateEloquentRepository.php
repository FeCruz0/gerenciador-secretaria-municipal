...
class ManagementReportUpdateEloquentRepository extends EloquentRepository
{
    #[Pure]
    ...
    public function create(array $data): ManagementReport | Model
    {
    ...
    public function update($id, array $data): ManagementReport | Model
    {
