...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'managementReport' => [
            'driver' => 'local',
            'root' => storage_path('app/public/images/managementReport'),
            'url' => env('APP_URL').'/storage/images/managementReport',
            'visibility' => 'public',
        ],
        ...
        'conservation_units' => [
            'driver' => 'local',
            'root' => storage_path('app/public/images/conservation_units'),
            'url' => env('APP_URL').'/storage/images/conservation_units',
            'visibility' => 'public',
        ],
