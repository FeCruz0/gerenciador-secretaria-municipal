...
export default function ConservationUnitCreate({ coverages = [], types = [] }) {
    const { data, setData, post, processing, errors } = useForm({
        title: '',
        conservation_unit_type_id: types[0]?.id ?? '',
        creation: '',
        creation_link: '',
        objective: '',
        area: '',
    ...
    function handleSubmit(e) {
        e.preventDefault();
        // Inertia useForm suporta envio de arquivos de forma transparente ao passar FormData.
        post(route('unid_conservacao.store'));
    }
    ...
    return (
        <AdminLayout title="Nova Unidade de Conservação">
            <Head title="Nova Unidade de Conservação" />

            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 28 }}>
                <div>
                    <h1 style={{ fontSize: 24, fontWeight: 700, color: '#f1f5f9', margin: 0 }}>Nova Unidade de Conservação</h1>
                    <p style={{ color: '#64748b', margin: '4px 0 0', fontSize: 14 }}>Cadastre uma nova área protegida municipal</p>
                </div>
            ...
            <div style={card}>
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 20 }}>
                        <div>
                            <label style={label} htmlFor="creation">Ato de Criação (ex: Decreto 123/2010) *</label>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20, marginBottom: 20 }}>
                        <div>
                            <label style={label} htmlFor="area">Área (ex: 500 ha) *</label>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 28, padding: 20, background: '#0f172a50', borderRadius: 8, border: '1px solid #33415550' }}>
                        <div>
                            <label style={label} htmlFor="thumb">Foto de Capa</label>
                        ...
                        <div>
                            ...
                            <input id="thumb_description" type="text" style={input} value={data.thumb_description} onChange={e => setData('thumb_description', e.target.value)} placeholder="Ex: Vista aérea do parque" />
                        </div>
                    </div>
