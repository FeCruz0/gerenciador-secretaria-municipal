            ...
            <div className="hidden lg:flex lg:w-2/3 items-center justify-center bg-slate-900 border-r border-slate-800/50 p-12 relative overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-lg flex flex-col items-center">
                    ...
                    <div className="text-center mt-8 space-y-2">
                        <h3 className="text-xl font-bold text-slate-200">Recuperação de Senha</h3>
                        <p className="text-slate-400 text-sm max-w-sm">
                            Caso tenha perdido seu acesso, informe seu e-mail cadastrado para que possamos enviar um link de redefinição de senha.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/3 flex items-center justify-center p-8 sm:p-12 md:p-16 bg-slate-950 relative">
                <div className="w-full max-w-sm space-y-6">
                    <div className="space-y-1">
                        <h2 className="text-2xl font-bold text-slate-100 tracking-tight">Recuperar Senha 🔒</h2>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <button 
                            ...
                            disabled={processing}
                        >
                            {processing ? 'Enviando...' : 'Enviar e-mail de recuperação'}
                        </button>
                    </form>
