            ...
            <div className="hidden lg:flex lg:w-2/3 items-center justify-center bg-slate-900 border-r border-slate-800/50 p-12 relative overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-lg flex flex-col items-center">
                    ...
                    <div className="text-center mt-8 space-y-2">
                        <h3 className="text-xl font-bold text-slate-200">Painel de Administração</h3>
                        <p className="text-slate-400 text-sm max-w-sm">
                            Gerencie as principais atividades administrativas, licitações, publicações e relatórios em uma única plataforma integrada.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="w-full max-w-sm space-y-6">
                    <div className="space-y-1">
                        ...
                        <p className="text-slate-400 text-sm">
                            Entre com sua conta para acessar o painel administrativo {unit?.name ? `do ${unit.name}` : ''}.
                        </p>
                    </div>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center">
                            ...
                            />
                            <label className="ml-2 text-sm text-slate-400 select-none cursor-pointer" htmlFor="remember_me">
                                Lembrar-me
                            </label>
                        </div>
