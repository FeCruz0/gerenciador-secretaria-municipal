...
export default function Show({ subject_selected, legislation_subjects, unit }) {
    const { flash } = usePage().props;
    const [formData, setFormData] = useState({
        subject: subject_selected.subject || '',
    });
    ...
    const handleSubmit = (e) => {
        ...
        Inertia.put(`/legislacao_assuntos/${subject_selected.id}`, formData, {
    ...
    return (
        <>
            <Head title={`Editar Assunto - ${subject_selected.subject}`} />
            ...
            <div style={{ padding: '32px', maxWidth: '1200px', margin: '0 auto' }}>
                ...
                <div style={{ marginBottom: '20px' }}>
                    <a href="/legislacao_assuntos" style={{
                        color: '#2563eb',
                        textDecoration: 'none',
                        fontWeight: 600,
                        fontSize: '0.9rem',
                        ...
                        ← Voltar para a Lista de Assuntos
                    </a>
                </div>
                    ...
                    <div>
                        <form onSubmit={handleSubmit} style={{
                            ...
                            <div style={{ display: 'flex', gap: '12px' }}>
                                ...
                                <button
                                    type="button"
                                    onClick={() => handleDelete(subject_selected.id)}
                                    style={{
                                        padding: '10px 16px',
                        ...
                        <div style={{
                            ...
                            <div style={{ maxHeight: '500px', overflowY: 'auto' }}>
                                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                                    <tbody>
                                        {legislation_subjects.map((sub) => {
                                            const isSelected = sub.id === subject_selected.id;
                                            return (
                                                <tr
                                                    key={sub.id}
                                                    style={{
