...
export default function Edit({ user, roles, organs }) {
    ...
    useEffect(() => {
        if (data.roles.length > 0) {
            const lastRoleName = data.roles[data.roles.length - 1];
    ...
    return (
        <AdminLayout title={`Editar Usuário: ${user.name}`}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1 relative">
                                    <label className="text-xs font-semibold text-slate-400 block">
                                        Senha de Acesso <span className="text-slate-500 font-normal">(deixe em branco para não alterar)</span>
                                    </label>
                                    <div className="relative">
                                        <input
                                            ...
                                            placeholder="Nova senha (se aplicável)"
                                        />
                                        <button
                                            type="button"
