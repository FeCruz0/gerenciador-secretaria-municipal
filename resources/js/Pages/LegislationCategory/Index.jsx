...
export default function Index({ legislation_categories, unit }) {
    ...
    const filtered = legislation_categories.filter(c =>
    ...
    const handleSubmit = (e) => {
        ...
        Inertia.post('/legislacao_categorias', formData, {
            onSuccess: () => resetForm(),
    ...
    return (
        <>
            <Head title="Categorias de Legislação" />
            ...
            <div style={{ padding: '32px', maxWidth: '1200px', margin: '0 auto' }}>
                ...
                {filtered.length === 0 ? (
                    <p style={{ color: '#94a3b8', textAlign: 'center', padding: '48px 0' }}>
                        Nenhuma categoria de legislação encontrada.
                    </p>
                ) : (
                    <div style={{
                        backgroundColor: '#fff',
