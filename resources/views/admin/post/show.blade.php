          ...
          <form class="form form-horizontal" method="POST" action="{{ route('capas.update', $post_selected->id) }}" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="link">Alterar Imagem <tag data-bs-toggle="tooltip" title=" Tamanho: 1280 x 720 px, centralizar informções"><i data-feather='info'></i></tag></label>
                  </div>
                  <div class="col-sm-9">
              ...
              <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="link">Imagem <tag data-bs-toggle="tooltip" title=" Tamanho: 1280 x 720 px, centralizar informções"><i data-feather='info'></i></tag></label>
                  </div>
                  <div class="col-sm-9">
                    <img
                      class="img-fluid rounded mb-75"
                      src="{{asset('storage/images/posts/' . $media_web->url)}}"
                      alt="avatar img"
                    />
                  </div>
                </div>
