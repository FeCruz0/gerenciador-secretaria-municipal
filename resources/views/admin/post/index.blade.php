          ...
          <form class="form form-horizontal" method="POST" action="{{ route('capas.store') }}" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="link">Imagem<strong>*</strong><tag data-bs-toggle="tooltip" title="Tamanho: 1280 x 720 px, centralizar informações para melhor adaptação no celular"><i data-feather='info'></i></tag></label>
                  </div>
                  <div class="col-sm-9">
                      <input type="file" class="form-control" id="image_web" name="image_web" >
                  </div>
                </div>
              </div>
              <div class="col-12">
