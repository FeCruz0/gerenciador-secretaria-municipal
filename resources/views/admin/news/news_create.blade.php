              ...
              <form class="auth-register-form mt-2" action="{{ route('noticias.store') }}" method="POST" enctype="multipart/form-data">
                @csrf()
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 mb-1">
                      <label class="form-label" for="select2-multiple">TAG'S<strong>*</strong><tag data-bs-toggle="tooltip" title="Não se esqueça de cadastrar as tag's previamente"><i data-feather='info'></i></tag></label>
