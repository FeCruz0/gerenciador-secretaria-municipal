    ...
    <form action="{{ route('permissions.update', $permission->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
          ...
          <input
              ...
              value="{{ old('name', isset($permission->name) ? $permission->name : '') }}" required
          />
        </div>
        <div class="col-md-12">
          ...
          <input
              ...
              value="{{ old('description', isset($permission->information->description) ? $permission->information->description : '') }}" required
          />
        </div>
