          ...
          <form class="form form-horizontal" method="POST" action="{{ route('web_atalhos.store') }}" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-12 mb-1">
                ...
                <input type="text" id="title" class="form-control" name="title" placeholder="Nome do Atalho" required />
              </div>
              <div class="col-md-12 mb-1">
                <label class="col-form-label" for="link_url">Link<strong>*</strong><tag data-bs-toggle="tooltip" title="Copie o link completo da barra de endereço do site desejado. Exemplo: 'https://www.google.com/'"><i data-feather='info'></i></tag></label>
